 ...
 * home so the affordance reads as "open this group" rather than "look at
 * a card with a separate Open action."
 */
export function GroupCard({ group, myRole }: Props) {
  ...
  return (
    <Link
      ...
      className="block rounded-[var(--radius-md)] border border-[var(--color-rule)] bg-[var(--color-surface)] px-4 py-3 transition-colors hover:bg-[var(--color-surface-2)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-bg)]"
    >
