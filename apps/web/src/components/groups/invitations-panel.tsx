...
export function InvitationsPanel({ group, enabled, onInvite }: Props) {
  ...
  return (
    <section className="space-y-2" aria-labelledby="invitations-heading">
      ...
      {isLoading ? (
        <div className="rounded-[var(--radius-md)] border border-[var(--color-rule)] bg-[var(--color-surface)] p-3 text-[0.75rem] text-[var(--color-ink-2)]">
          Loading invitations…
        </div>
      ) : entries.length === 0 ? (
        <div className="rounded-[var(--radius-md)] border border-[var(--color-rule)] bg-[var(--color-surface)] p-3 text-[0.75rem] text-[var(--color-ink-2)]">
              ...
              >
                <div className="flex min-w-0 flex-1 items-center gap-3">
                  ...
                  <div className="min-w-0 flex-1 text-[0.8125rem]">
                    ...
                    <div
                      className="mt-0.5 truncate text-[0.6875rem] text-[var(--color-ink-2)]"
